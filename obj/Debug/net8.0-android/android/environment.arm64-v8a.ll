...
@dso_cache = dso_local local_unnamed_addr global [44 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libHarfBuzzSharp.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
...
@.env.7 = private unnamed_addr constant [37 x i8] c"a48575be-3091-42cf-b3ce-a40fa403b5e6\00", align 1
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [34 x i8] c"com.companyname.summerworkproject\00", align 1

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [20 x i8] c"libHarfBuzzSharp.so\00", align 1
